...
<div class="dash-side-nav-wrapper" id="dash-side-menu">
    <div class="dash-side-nav perfect-scroll">
        ...
        <ul class="list-unstyled dash-menu">
            ...
            <li><a href="<%=basePath%>user/allWants" class="current"><i class="fa fa-star-o"></i><span>我的求购</span></a></li>
...
<div class="content-wrapper">
    ...
    <div class="dash-items">
        <div class="items-mini-menu">
            <a href="<%=basePath%>books/addBooks"><i class="fa fa-plus-circle text-info"></i> <span><em>发布求购</em></span></a>
        </div>
